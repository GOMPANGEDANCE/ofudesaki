    ...
    private fun loadTemporaryData() {
        ...
        allContent.add(
            ContentItem(
                ...
                commentary = "52,그러기 위해서는 세상 사람들의 마음을 청소하지 않으면 안된다. 그래서 어버이신은 스스로 빗자루가 되어 청소하ㅐ 테니, 나타나는 리를 단단히 주의해서 보도록 하라."
            )
        )
        allContent.add(
            ContentItem(
        ...
        allContent.add(
            ContentItem(
                ...
                commentary = "86, 87,어버이신은 나날이 구제한줄기의 길을 서두르고 있으나, 자녀들은 이것을 모르니 참으로 안타깝다. 자녀도 적은 수가 아닌 많은 사람이 어버이신의 마음을 모르므로 세상은 더욱 혼동할 수 밖에 없6ㅏ."
            )
        )
        ...
        allContent.add(
            ContentItem(
                ...
                japanese = "",
                english = "",
                commentary = "67. 인간은 어리석기 대ㄷ문에 어버이신이 무슨 말을 해도 그 참뜻을 모르고 이러쿵 저러쿵 말들을 한다"
            )
        )
        allContent.add(
            ContentItem(
