    ...
    private fun loadTemporaryData() {
        ...
        allContent.add(
            ContentItem(
                ...
                commentary = "四十二, 第三호 八十八～九十 참조, 다음 노래의 주석 참조."
            )
        )
        allContent.add(
            ContentItem(
        ...
        allContent.add(
            ContentItem(
                ...
                commentary = "六十一, 六十二,어두운 테란 어버이신님이 위엄을 나타내지 않고 보료하고 계셨다는 뜻으로서, 구체적으로는 교조님이 지금까지 검은 예복을 입고 계신 것을 가리킨다.\n 밝은 곳이란 어버이신님이 몸소 세상 밖으로 모습을 나타내신다는 뜻으로, 구체적으로 교조님이 야마무라고뗑에 다녀오신 후부터 붉은 옷을 입으신 것을 가리킨다.(第三호 四十二 주석, 第五호 五十六, 五十七의 주석 참조)"
            )
        )
        allContent.add(
            ContentItem(
        ...
        allContent.add(
            ContentItem(
                ...
                commentary = "큰 신사 높은 산이란 당시 권세를 휘둘러 본교를 탄압한 사람들을 말한다. 이 노래는 제멋대로 권세를 휘둘러 본교를 탄압해 온 사람들도 마음을 반성하지 않으면 언제 어느 때 어버이신님이 뛰어 나가 어떤 일을 할는지 모른다는 말씀이다.(第五호 五十六, 五十七의 주석 참조)\n"
            )
        )
        allContent.add(
            ContentItem(
        ...
        allContent.add(
            ContentItem(
                ...
                japanese = "",
                english = "",
                commentary = "이제부터는 세상 사람 누구도 모르는 이야기만 하겠는데, 그것은 무슨 일이든 모르는 것이 없도록 만가지를 자세히 가르치고 싶기 때문이니, 사람들은 인간을 한결같이 귀여운 자녀로 여기는 어버이신의 차별 없는 어버이마음을 잘 깨달아서, 어버이신이 하는 말을 단단히 들어주기 바란다.\n 미칠곳이나 미친곳이나 아무 차별을 하지 않는 것이 진실한 어버이마음이다. 즉, 어버이신님이 보실 땐, 미칠곳이나 미친곳이나 모두 귀여운 자녀가 사는 곳이며, 먼저 안 사람이나 나중에 알 사람이나 다 같은 귀여운 자녀이다. 또 어버이신님의 뜻을 깨닫고 따라오는 사람도 반대하는 사람도 모두 귀여운 자녀이다. 따라서 궁극적으로는 온 세상 사람들을 모두 구제하시려는 것이 어버이신님의 구제한줄기의 참뜻이다. 제2호에서부터 미칠곳과 미친곳에 대해 가르쳐 오신 어버이신님의 뜻은 바로 여기에 있다.(제2호 34의 주석 참조)"
            )
        )
        allContent.add(
            ContentItem(
