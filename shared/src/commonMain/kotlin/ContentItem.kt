package com.example.ofudesaki.shared // 👈 패키지명 확인

class PoemRepository {

    // 1. 기존 코드와 똑같은 이름으로 리스트를 만듭니다.
    private val allContent = mutableListOf<ContentItem>()

    // 2. 클래스가 생성될 때 실행되는 블록입니다.
    init {
        ...
        allContent.add(
            ContentItem(
                korean = " 아무리 어려운 일이라 할지라도\n 신이 진실을 받아들인다면 5-40\n",
                japanese = "どのよふなむつかし事とゆうたとて　神がしんちつうけとりたなら",
                english = "dono yona mutsukashi koto to yuta tote\n" +
        ...
        allContent.add(
            ContentItem(
                ...
                japanese = "十人のなかに三人かたうでわ　火水風ともしりぞくとしれ",
        ...
        allContent.add(
            ContentItem(
                ...
                japanese = "むまれこふほふそはしかもせんよふに　やますしなすにくらす事なら",
    ...
    // 3. 밖으로 내보낼 때는 수정 불가능한 리스트로 줍니다.
    fun getPoemList(): List<ContentItem> {
        return allContent
    }
}